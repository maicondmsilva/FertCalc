...
function mapCotacaoSolicitada(d: Record<string, unknown>): CotacaoSolicitada {
  ...
  return {
    ...
    inscricao_estadual: d.inscricao_estadual as string | undefined,
    cidade_entrega: d.cidade_entrega as string | undefined,
    estado_entrega: d.estado_entrega as string | undefined,
